...
select 'elig.mstrEligBenefitData' as TableName,a.IsActive as IsActive_elig, b.isActive as IsActive_Members, mstrEligID, a.NHlinkID, b.NHMemberid, a.Isactive, a.CreateDate, a.ModifyDate, a.dataSource, a.benefitstartdate, a.benefitenddate, a.recordEffDate, a.recordEndDate, a.firstname, a.lastname,  a.subscriberID, a.DOB, a.Isactive,    a.MasterMemberID, a.MemberInsuranceID, a.insCarrierID, a.insHealthPlanId, a.*
...
select 'otcfunds.CardBenefitLoad' as TableName, IsActive, * from otcfunds.CardBenefitLoad where NHLinkid in (select NHLinkID from master.Members where NHMemberID in (select NHmemberID from #NHMemberIDTemp)) order by 1
