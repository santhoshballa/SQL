...
-- No Of Catalogs per Month for Experience Health
select 'Jan' as Month, Count(*) as NoOfCatalog from #TSupplOrdersCatalog
where OrderDate > = '01-01-2022' and OrderDate <= '01-31-2022'
union
select 'Feb' as Month, Count(*) as NoOfCatalog from #TSupplOrdersCatalog
where OrderDate > = '02-01-2022' and OrderDate <= '02-28-2022'
union
select 'March' as Month, Count(*) as NoOfCatalog from #TSupplOrdersCatalog
