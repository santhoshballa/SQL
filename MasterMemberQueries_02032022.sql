...
insert into #NHMemberIDTemp (NHMemberID) values ('NH202004583131') -- ticket # 58265
...
select distinct top 5 'WexQuery | CurrentPlanYearOnly' as Query, 'otc.MemberEligibility' as TableName,  isnull(NHMemberID, 'Member Not Found') as NHMemberID, 
